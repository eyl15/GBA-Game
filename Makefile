...
OFILES = health.o gba.o font.o main.o images/garbage.o images/start.o images/win.o images/lose.o images/gojo.o images/sukuna.o images/HollowR.o images/HollowP.o images/HollowB.o images/slash.o
